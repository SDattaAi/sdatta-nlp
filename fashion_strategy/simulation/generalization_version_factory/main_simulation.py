from fashion_strategy.simulation.generalization_version_factory.utils import initialize_all_the_dicts
from fashion_strategy.simulation.generalization_version_factory.utils import initialize_kpi_structures
from fashion_strategy.simulation.generalization_version_factory.utils import update_current_stock_with_new_sku
from fashion_strategy.simulation.generalization_version_factory.utils import update_current_stock_with_kill_sku
from fashion_strategy.simulation.generalization_version_factory.utils import receive_stock
from fashion_strategy.simulation.generalization_version_factory.utils import update_kpi_wo_inv
from fashion_strategy.simulation.generalization_version_factory.utils import update_stocks_by_sales
from fashion_strategy.simulation.generalization_version_factory.utils import update_active_stores
from fashion_strategy.simulation.generalization_version_factory.utils import update_info_for_kpi
from fashion_strategy.simulation.generalization_version_factory.utils import kill_and_save_results
from fashion_strategy.simulation.generalization_version_factory.strategy_selector.strategy_selector import StrategySelector
from fashion_strategy.simulation.generalization_version_factory.forecaster.forecast_factory.forecast_factory import ForecastFactory
from fashion_strategy.simulation.generalization_version_factory.strategies.strategies_factory.strategies_factory import StrategyFactory
import pandas as pd
