from fashion_strategy.simulation.generalization_version_factory.strategies.naive_bayes_strategy import NaiveBayesStrategy
from fashion_strategy.simulation.generalization_version_factory.strategies.high_demand_strategy import HighDemandStrategy
from fashion_strategy.simulation.generalization_version_factory.strategies.eoq_strategy import EoqStrategy
from fashion_strategy.simulation.generalization_version_factory.strategies.jit_strategy import JitStrategy
