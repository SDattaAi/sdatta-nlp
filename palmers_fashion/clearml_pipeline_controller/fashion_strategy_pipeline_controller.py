...
controller = PipelineController(project="palmers/training",
...
controller.add_step(name="step1_load_all_relevant_data_for_fashion",
                    base_task_project="palmers/training",
...
for number_of_machine in range(number_of_machines):
    fashion_strategy_calculation_node_name = f"step0_preparation_{number_of_machine}"
    controller.add_step(name=fashion_strategy_calculation_node_name,
                        base_task_project="palmers/training",  #####sales_filled_table_name
                        base_task_name="step0_preparation_task",
